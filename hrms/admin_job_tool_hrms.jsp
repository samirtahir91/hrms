...
<ul id="nav">
<li><a href="admin_job_tool_hrms.jsp" title="Add" class="on">Add</a></li>
<li><a href="admin_edit_job_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="admin_del_job_hrms.jsp" title="Delete">Delete</a></li>
</ul>
