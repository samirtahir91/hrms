...
<title>HRMS: Add Appraisal to Employee</title>
...
<li><a href="emp_add_appr_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="emp_add_appr_review_hrms.jsp" title="Review">Review</a></li>
<li><a href="emp_del_appr_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<div id="content">
<h2>Add appraisal to employee</h2>
<p>Select the employee's username below, then enter the appraisal details to be added.</p>
...
<tr>
<td>Target:</td>
<td><input type="text" size= "15" name="trget" /></td>
</tr>
<tr>
<td>Set date:</td>
...
try{	
	...
	String trget = request.getParameter("trget");
	          	if(sdate!=""&&trget!=""&&uid!=""){

	String add_appr= "insert into employee_has_appraisal (employee_employee_id, employee_username, target, set_date) values (?, ?, ?, ?)";
	...
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Make sure employee is selected and the fields are filled in correctly</b></font></td>
	</tbody>    	
	</table>
	<%
	}
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Appraisal has been successfully added to employee</b></font></td>
    	</table>
<%
              }
