...
<li><a href="admin_edit_skill_hrms.jsp" title="Edit" class="on">Edit</a></li>
<li><a href="admin_del_skill_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=admin_edit_skill_hrms.jsp");
