...
<p align="center"><b>Skills report</b><br>&nbsp;</p>

<div align="center" width="85%">
<center>
<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
<tbody>
<td bgColor="#008080" width="47" align="center" height="19"><font color="#ffffff"><b>Skill</b></font></td>
<td bgColor="#008080" width="270" height="19"><font color="#ffffff"><b>Experience (years)</b></font></td>
...
rst=stmt.executeQuery("select skill.skill_name, employee_has_skill.experience from skill join employee_has_skill on (skill.skill_id = employee_has_skill.skill_skill_id) where employee_has_skill.employee_username='"+user_id+"'");
while(rst.next()){
