...
rst=stmt.executeQuery("select lleave.type, employee_has_leave.start_date, end_date from hr_data.lleave join employee_has_leave on lleave.leave_id = employee_has_leave.leave_leave_id where employee_has_leave.employee_username='"+user_id+"'"
);
while(rst.next()){
