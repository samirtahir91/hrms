...
<title>HRMS: Training search</title>
...
<li><a href="admin_training_srch_hrms.jsp" title="Search"class="on">Search</a></li>
<li><a href="emp_add_training_hrms.jsp" title="Add" >Add</a></li>
...
<p>Select the training to view employees that have completed it.</p>
<div>
</div>
...
<%		
		...
		rst=stmt.executeQuery("select * from employee join employee_has_training on (employee_id = employee_has_training.employee_employee_id) where employee_has_training.training_training_id='"+new_id+"'");
