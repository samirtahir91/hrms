...
<ul id="nav">
<li><a href="admin_dep1_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="admin_edit_dep1_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="admin_del_dep1_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=admin_del_dep1_hrms.jsp");
