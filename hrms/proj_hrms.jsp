...
<tbody>
<td bgColor="#008080" width="47" align="center" height="19"><font color="#ffffff"><b>Project</b></font></td>
...
rst=stmt.executeQuery("select project.project_name, start_date, end_date from project join employee_has_project on (project.project_id = employee_has_project.project_project_id) where employee_has_project.employee_username='"+user_id+"'");
while(rst.next()){
