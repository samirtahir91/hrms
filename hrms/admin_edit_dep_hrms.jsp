...
<li><a href="admin_edit_dep_hrms.jsp" title="Edit" class="on">Edit</a></li>
<li><a href="admin_del_dep_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=admin_edit_dep_hrms.jsp");
