...
<title>HRMS: Add Job to Employee</title>
...
<ul id="nav">
<li><a href="admin_job_hrms.jsp" title="Report">Report</a></li>
<li><a href="admin_job_srch_hrms.jsp" title="Search">Search</a></li>
<li><a href="emp_add_job_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="emp_del_job_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<div id="content">
<h2>Add job to employee</h2>
<p>Select the employee's username below, then select the job to be added.</p>
...
try{
	...
	ResultSet rs4=st4.executeQuery("Select * from job");
	String jname="";
	String jid="";
	while(rs4.next()){
	jname=rs4.getString("job_name");
	jid=rs4.getString("job_id");
%>

<option value="<%=jid%>"><%=jname%></option>
...
try{	
	...
	String j_id = request.getParameter("jname");
	          	if(j_id!=""&& sdate!=""&&edate!=""&&uid!=""){

	String add_job= "insert into employee_has_job (employee_employee_id, employee_username, job_job_id, start_date, end_date) values (?, ?, ?, ?, ?)";
	...
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Make sure employee and job are selected</b></font></td>
	</tbody>    	
	</table>
	<%
	}
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Job has been successfully added to employee</b></font></td>
    	</table>
<%
              }
