...
<title>HRMS: Add Training to Employee</title>
...
<ul id="nav">
<li><a href="admin_training_hrms.jsp" title="Report">Report</a></li>
<li><a href="admin_training_srch_hrms.jsp" title="Search">Search</a></li>
<li><a href="emp_add_training_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="emp_del_training_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<div id="content">
<h2>Add training to employee</h2>
<p>Select the employee's username below, then select the training to be added.</p>
...
try{
	...
	ResultSet rs4=st4.executeQuery("Select * from training");
	String trname="";
	String trnid="";
	while(rs4.next()){
	trname=rs4.getString("training_name");
	trnid=rs4.getString("training_id");
%>

<option value="<%=trnid%>"><%=trname%></option>
...
try{	
	String t_id = request.getParameter("tname");
	          	if(t_id!="" && uid!=""){

	String add_trn= "insert into employee_has_training (employee_employee_id, employee_username, training_training_id) values (?, ?, ?)";
	...
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Make sure employee and training are selected</b></font></td>
	</tbody>    	
	</table>
	<%
	}
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Training has been successfully added to employee</b></font></td>
    	</table>
<%
              }
