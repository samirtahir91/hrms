...
<ul id="nav">
<li><a href="admin_train_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="admin_edit_training_hrms.jsp" title="Edit" class="on">Edit</a></li>
...
<%
		response.setHeader("Refresh", "2; URL=admin_edit_training_hrms.jsp");
