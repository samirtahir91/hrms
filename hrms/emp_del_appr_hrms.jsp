...
<title>HRMS: Delete Appraisal From Employee</title>
...
<ul id="nav">
<li><a href="admin_appraisal_hrms.jsp" title="Report">Report</a></li>
<li><a href="emp_add_appr_hrms.jsp" title="Add" >Add</a></li>
<li><a href="emp_add_appr_review_hrms.jsp" title="Review">Review</a></li>
<li><a href="emp_del_appr_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<p>Select the employee and the appraisal to be removed from the drop down menus below.</p>
<div>
</div>
...
<%
	...
	ResultSet rs3=st3.executeQuery("Select * from employee_has_appraisal");
	String u2name="";
	while(rs3.next()){
	u2name=rs3.getString("target");
...
<%		
		...
		String del_appr= "delete from employee_has_appraisal where employee_employee_id = ? and target = ?";
		PreparedStatement pst=con.prepareStatement(del_appr);

		String aname = request.getParameter("aname");
		if(!aname.equals("")&&!uid.equals("")){
		pst.setString(1, uid);
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Appraisal has been successfully removed from the employee</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=emp_del_appr_hrms.jsp");
		...
		%>
       		...
       		<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
		<tbody>
		<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>No appraisal or employee selected</b></font></td>
		</tbody>    	
		</table>
		<%
		}
