...
<title>HRMS: Delete Department</title>
...
<li><a href="http://localhost:8080/admin_del_dep1_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<p>Select the department to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_dep= "delete from department where department_name = ?";
		PreparedStatement pst=con.prepareStatement(del_dep);
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=dname%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_dep1_hrms.jsp");
