...
<title>HRMS: Delete Skill From Employee</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_skill_hrms.jsp" title="Report">Report</a></li>
<li><a href="http://localhost:8080/admin_skill_srch_hrms.jsp" title="Search">Search</a></li>
<li><a href="http://localhost:8080/emp_add_skill_hrms.jsp" title="Add"  >Add</a></li>
<li><a href="http://localhost:8080/emp_del_skill_hrms.jsp" title="Delete"class="on">Delete</a></li>
</ul>
...
<div id="content">
<h2>Delete skill</h2>
<p>Select the employee and the skill to be removed from the drop down menus below.</p>
<div>
</div>
...
<%
	...
	ResultSet rs3=st3.executeQuery("Select * from skill");
	String u2name="";
	String s_id="";
	while(rs3.next()){
	u2name=rs3.getString("skill_name");
	s_id=rs3.getString("skill_id");
%>

<option value="<%=s_id%>"><%=u2name%></option>
...
<%		
		...
		String del_skl= "delete from employee_has_skill where employee_employee_id = ? and skill_skill_id = ?";
		PreparedStatement pst=con.prepareStatement(del_skl);

		String sname = request.getParameter("sname");
		if(!sname.equals("")&&!uid.equals("")){
		pst.setString(1, uid);
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Skill has been successfully removed from the employee</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/emp_del_skill_hrms.jsp");
		...
		%>
       		...
       		<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
		<tbody>
		<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>No skill or employee selected</b></font></td>
		</tbody>    	
		</table>
		<%
		}
