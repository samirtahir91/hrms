...
<title>HRMS: Delete Employee</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_add_hrms.jsp" title="Add" >Add</a></li>
<li><a href="http://localhost:8080/admin_edit_hrms.jsp" title="Edit" >Edit</a></li>
<li><a href="http://localhost:8080/admin_del_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<p>Select the employee's username to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_emp= "delete from employee where username = ?";
		PreparedStatement pst=con.prepareStatement(del_emp);
		String u1name = request.getParameter("user");
		if(!u1name.equals("")){
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=u1name%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_hrms.jsp");
