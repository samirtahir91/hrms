...
<li><a href="http://localhost:8080/admin_del_dep_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_dep_hrms.jsp");
