...
<li><a href="http://localhost:8080/emp_del_appr_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/emp_del_appr_hrms.jsp");
