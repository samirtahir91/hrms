...
<title>HRMS: Add Project to System</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_proj_tool_hrms.jsp" title="Add" class="on">Add</a></li>
...
<div id="content">
<h2>Add project to system</h2>
<p>Enter the new project details in the fields specified below, note all entries must not exceed the limits given.</p>
...
<tr>
<td>Project name:</td>
<td><input type="text" size= "15" name="pname" /></td>
</tr>
<tr>
<td>Start date:</td>
...
try{
	...
	if(pname!=null && sdate!=null && edate!=null){
                         // check if the text box having only blank spaces
          		if(pname!="" && sdate!="" && edate!=""){

	String add_prj= "insert into project (project_id, project_name, start_date, end_date) values (?, ?, ?, ?)";
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=pname%> has been successfully added to the database</b></font></td>
    	</table>
<%
              }
