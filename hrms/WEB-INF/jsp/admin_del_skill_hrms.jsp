...
<ul id="nav">
<li><a href="http://localhost:8080/admin_skill_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="http://localhost:8080/admin_edit_skill_hrms.jsp" title="Edit" >Edit</a></li>
<li><a href="http://localhost:8080/admin_del_skill_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<div id="content">
<h2>Delete skill</h2>
<p>Select the skill to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_skill= "delete from skill where skill_name = ?";
		PreparedStatement pst=con.prepareStatement(del_skill);
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=sname%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_skill_hrms.jsp");
