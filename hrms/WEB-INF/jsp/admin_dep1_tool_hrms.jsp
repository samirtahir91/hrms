...
<ul id="nav">
<li><a href="http://localhost:8080/admin_dep1_tool_hrms.jsp" title="Add" class="on">Add</a></li>
<li><a href="http://localhost:8080/admin_edit_dep1_hrms.jsp" title="Edit">Edit</a></li>
