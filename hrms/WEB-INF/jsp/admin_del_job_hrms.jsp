...
<ul id="nav">
<li><a href="http://localhost:8080/admin_job_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="http://localhost:8080/admin_edit_job_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="http://localhost:8080/admin_del_job_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<div id="content">
<h2>Delete job</h2>
<p>Select the job to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_job= "delete from job where job_name = ?";
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=jname%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
