...
<li><a href="http://localhost:8080/admin_job_srch_hrms.jsp" title="Search">Search</a></li>
<li><a href="http://localhost:8080/emp_add_job_hrms.jsp" title="Add"  class="on">Add</a></li>
