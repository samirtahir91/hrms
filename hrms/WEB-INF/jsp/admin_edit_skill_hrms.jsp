...
<li><a href="http://localhost:8080/admin_edit_skill_hrms.jsp" title="Edit" class="on">Edit</a></li>
...
<div id="content">
<h2>Edit skill</h2>
<p>Select the skill to be altered, then enter the replacement below.</p>
<div>
</div>
...
<%		
		...
		String alt_skill= "update skill set skill_name = ? where skill_name = ?";
		PreparedStatement pst=con.prepareStatement(alt_skill);
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_edit_skill_hrms.jsp");
