...
<ul id="nav">
<li><a href="http://localhost:8080/admin_proj_hrms.jsp" title="Report"  class="on">Report</a></li>
...
rst=stmt.executeQuery("select project.project_name, start_date, end_date from project join employee_has_project on (project.project_id = employee_has_project.project_project_id) where employee_has_project.employee_username='"+userid+"'");
...
<tbody>
<td bgColor="#006699" width="47" align="center" height="19"><font color="#ffffff"><b>Project</b></font></td>
