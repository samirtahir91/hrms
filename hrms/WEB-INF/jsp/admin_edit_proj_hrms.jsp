...
<li><a href="http://localhost:8080/admin_edit_proj_hrms.jsp" title="Edit" class="on">Edit</a></li>
<li><a href="http://localhost:8080/admin_del_proj_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<div id="content">
<h2>Edit project</h2>
<p>Select the project to be altered, then select the attribute from the drop down menus and enter the replacement below.</p>
<div>
</div>
...
<%		
		...
		String alt_proj= "update project set "+oldattr+" = ? where project_name = ?";
		PreparedStatement pst=con.prepareStatement(alt_proj);
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_edit_proj_hrms.jsp");
