...
<title>HRMS: Placement search</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_dep_hrms.jsp" title="Report">Report</a></li>
<li><a href="http://localhost:8080/admin_dep_srch_hrms.jsp" title="Search"class="on">Search</a></li>
...
<p>Select the department to view employees that belong to it.</p>
<div>
</div>
...
if(rst1.getString(1).equals("admin")){
	...
	String u2id="";
	while(rs.next()){
	u2id=rs.getString("department_id");
...
<%		
		...
		String new_id = request.getParameter("dname");
		
		con = DriverManager.getConnection(url, "tahirs2", "samir");
		stmt=con.createStatement();
		rst=stmt.executeQuery("select * from employee where employee.department_department_id='"+new_id+"'");
