...
<li><a href="http://localhost:8080/admin_edit_job_hrms.jsp" title="Edit" class="on">Edit</a></li>
...
<div id="content">
<h2>Edit job</h2>
<p>Select the job to be altered, then select the attribute from the drop down menus and enter the replacement below.</p>
<div>
</div>
...
<%		
		...
		String alt_job = "update job set "+oldattr+" = ? where job_name = ?";
		PreparedStatement pst=con.prepareStatement(alt_job);
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_edit_job_hrms.jsp");
