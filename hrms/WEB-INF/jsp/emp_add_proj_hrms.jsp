...
<title>HRMS: Add Project to Employee</title>
...
<li><a href="http://localhost:8080/emp_add_proj_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="http://localhost:8080/emp_del_proj_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<p>Select the employee's username below, then select the project to be added.</p>
...
try{
	...
	ResultSet rs4=st4.executeQuery("Select * from project");
	String pname="";
	String pid="";
	while(rs4.next()){
	pname=rs4.getString("project_name");
	pid=rs4.getString("project_id");
%>
...
try{	
	...
	String add_prj= "insert into employee_has_project (employee_employee_id, employee_username, project_project_id) values (?, ?, ?)";
	con2=DriverManager.getConnection(url, "tahirs2", "samir");
	pstmt2=con2.prepareStatement(add_prj);
	...
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Make sure employee and project are selected</b></font></td>
	</tbody>    	
	</table>
	<%
	}
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Project has been successfully added to employee</b></font></td>
    	</table>
<%
              }
