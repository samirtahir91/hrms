...
<li><a href="http://localhost:8080/admin_skill_srch_hrms.jsp" title="Search"class="on">Search</a></li>
...
<div id="content">
<h2>Skill search</h2>
<p>Select the skill to view employees that posses it.</p>
<div>
</div>
...
if(rst1.getString(1).equals("admin")){
	...
	String u2id="";
	while(rs.next()){
	u2id=rs.getString("skill_id");
	u2name=rs.getString("skill_name");
%>
...
<%		
		...
		String new_id = request.getParameter("sname");
		
		con = DriverManager.getConnection(url, "tahirs2", "samir");
		stmt=con.createStatement();
		rst=stmt.executeQuery("select * from employee join employee_has_skill on (employee_id = employee_has_skill.employee_employee_id) where employee_has_skill.skill_skill_id='"+new_id+"'");
...
%>
       	...
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>No skill selected.</b></font></td>
	</tbody>    	
	</table>
<%
}
