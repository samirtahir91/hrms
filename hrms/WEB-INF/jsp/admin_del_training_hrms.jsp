...
<title>HRMS: Delete Training</title>
...
<li><a href="http://localhost:8080/admin_edit_training_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="http://localhost:8080/admin_del_training_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<p>Select the training to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_trn= "delete from training where training_name = ?";
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=tname%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_training_hrms.jsp");
