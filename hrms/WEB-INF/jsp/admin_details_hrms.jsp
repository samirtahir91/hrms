...
<ul id="nav">
<li><a href="http://localhost:8080/admin_details_hrms.jsp" title="Report" class="on">Report</a></li>
<li><a href="http://localhost:8080/admin_details_srch_hrms.jsp" title="Edit" >Search</a></li>
</ul>
...
rst=stmt.executeQuery("select * from employee where username='"+userid+"'");
...
%>
       	...
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Invalid username, check spelling and make sure field is filled in.</b></font></td>
	</tbody>    	
	</table>
<%
}
