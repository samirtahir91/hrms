...
<title>HRMS: Add Skill to Employee</title>
...
<li><a href="http://localhost:8080/emp_add_skill_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="http://localhost:8080/emp_del_skill_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<p>Select the employee's username below, then select the skill to be added.</p>
...
try{
	...
	ResultSet rs4=st4.executeQuery("Select * from skill");
	String sklname="";
	String sklid="";
	while(rs4.next()){
	sklname=rs4.getString("skill_name");
	sklid=rs4.getString("skill_id");
%>
...
<tr>
<td>Experience:</td>
<td><input type="text" size= "15" name="exp" /></td>
...
try{	
	...
	String s_id = request.getParameter("sname");
	          	if(s_id!="" && exp!= "" &&uid!=""){

	String add_skl= "insert into employee_has_skill (employee_employee_id, employee_username, skill_skill_id, experience) values (?, ?, ?, ?)";
	...
	pstmt2.setString(3, s_id);
	pstmt2.setString(4, exp);
	...
	<tbody>
	<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>Make sure employee and skill are selected</b></font></td>
	</tbody>    	
	</table>
	<%
	}
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b>Skill has been successfully added to employee</b></font></td>
    	</table>
<%
              }
