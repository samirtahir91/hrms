...
<title>HRMS: Edit Location</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_dep_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="http://localhost:8080/admin_edit_dep_hrms.jsp" title="Edit" class="on">Edit</a></li>
...
<div id="content">
<h2>Edit location</h2>
<p>Select the location to be altered, then select the attribute from the drop down menus and enter the replacement below.</p>
<div>
</div>
...
<%		
		...
		String alt_loc= "update location set "+oldattr+" = ? where address = ?";
		PreparedStatement pst=con.prepareStatement(alt_loc);
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_edit_dep_hrms.jsp");
