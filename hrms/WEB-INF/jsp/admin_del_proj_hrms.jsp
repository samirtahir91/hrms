...
<title>HRMS: Delete Project</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_proj_tool_hrms.jsp" title="Add" >Add</a></li>
<li><a href="http://localhost:8080/admin_edit_proj_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="http://localhost:8080/admin_del_proj_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<p>Select the project to be removed from the drop down menu below.</p>
<div>
</div>
...
if(rst1.getString(1).equals("admin")){
	...
	String u2name="";
	while(rs.next()){
	u2name=rs.getString("project_name");
%>
...
<%		
		...
		String del_proj= "delete from project where project_name = ?";
		PreparedStatement pst=con.prepareStatement(del_proj);
...
%>
		...
		<tbody>
		<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=pname%> has been successfully removed from the database</b></font></td>
		</tbody>    	
		</table>
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_proj_hrms.jsp");
		...
		%>
       		...
       		<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
		<tbody>
		<td bgColor="#A52A2A" width="100" align="center" height="19"><font color="#ffffff"><b>No project selected</b></font></td>
		</tbody>    	
		</table>
		<%
		}
