...
<ul id="nav">
<li><a href="http://localhost:8080/admin_leave_hrms.jsp" title="Report"class="on">Report</a></li>
<li><a href="http://localhost:8080/emp_add_leave_hrms.jsp" title="Add"  >Add</a></li>
...
rst=stmt.executeQuery("select lleave.type, employee_has_leave.start_date, end_date from hr_data.lleave join employee_has_leave on lleave.leave_id = employee_has_leave.leave_leave_id where employee_has_leave.employee_username='"+userid+"'"
);
...
<tbody>
<td bgColor="#006699" width="47" align="center" height="19"><font color="#ffffff"><b>Type</b></font></td>
