...
<li><a href="http://localhost:8080/admin_edit_leave_hrms.jsp" title="Edit" >Edit</a></li>
<li><a href="http://localhost:8080/admin_del_leave_hrms.jsp" title="Delete" class="on">Delete</a></li>
</ul>
...
<div id="content">
<h2>Delete leave</h2>
<p>Select the leave to be removed from the drop down menu below.</p>
<div>
</div>
...
<%		
		...
		String del_leave= "delete from lleave where type = ?";
		PreparedStatement pst=con.prepareStatement(del_leave);
...
<%
		response.setHeader("Refresh", "2; URL=http://localhost:8080/admin_del_leave_hrms.jsp");
