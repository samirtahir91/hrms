...
<li><a href="http://localhost:8080/emp_add_training_hrms.jsp" title="Add"  class="on">Add</a></li>
<li><a href="http://localhost:8080/emp_del_training_hrms.jsp" title="Delete">Delete</a></li>
</ul>
