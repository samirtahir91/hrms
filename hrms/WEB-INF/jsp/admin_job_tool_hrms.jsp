...
<title>HRMS: Add Job to System</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_job_tool_hrms.jsp" title="Add" class="on">Add</a></li>
<li><a href="http://localhost:8080/admin_edit_job_hrms.jsp" title="Edit">Edit</a></li>
<li><a href="http://localhost:8080/admin_del_job_hrms.jsp" title="Delete">Delete</a></li>
</ul>
...
<div id="content">
<h2>Add job to system</h2>
<p>Enter the new job details in the fields specified below, note all entries must not exceed the limits given.</p>
...
<tr>
<td>Job name:</td>
<td><input type="text" size= "15" name="jname" /></td>
</tr>
<tr>
<td>Minimum salary:</td>
<td><input type="text" size= "15" name="minsal" />
</td>
</tr>
<tr>
<td>Maximum salary:</td>
<td><input type="text" size= "15" name="maxsal" /></td>
...
rst=stmt.executeQuery("select * from job where job.job_id = (select max(job_id) from job)");
rst.next();
...
try{
	...
	if(jname!=null && minsal!=null && maxsal!=null){
                         // check if the text box having only blank spaces
          		if(jname!="" && minsal!="" && maxsal!=""){

	String add_job= "insert into job (job_id, job_name, min_salary, max_salary) values (?, ?, ?, ?)";
	con2=DriverManager.getConnection(url, "tahirs2", "samir");
	pstmt2=con2.prepareStatement(add_job);
	
	pstmt2.setString(1, current_id);
	pstmt2.setString(2, jname);	
	pstmt2.setString(3, minsal);
	pstmt2.setString(4, maxsal);
...
%>
       	<table border="1" borderColor="#ffe9bf" cellPadding="0" cellSpacing="0" width="800" height="63">
	<tbody>
	<td bgColor="#006699" width="100" align="center" height="19"><font color="#ffffff"><b><%=jname%> has been successfully added to the database</b></font></td>
    	</table>
<%
              }
