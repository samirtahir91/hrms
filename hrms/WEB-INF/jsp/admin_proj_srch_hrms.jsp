...
<title>HRMS: Project search</title>
...
<li><a href="http://localhost:8080/admin_proj_srch_hrms.jsp" title="Search"class="on">Search</a></li>
...
<p>Select the project to view employees that are involved.</p>
<div>
</div>
...
<%		
		...
		String new_id = request.getParameter("pname");
		
		con = DriverManager.getConnection(url, "tahirs2", "samir");
		stmt=con.createStatement();
		rst=stmt.executeQuery("select * from employee join employee_has_project on (employee_id = employee_has_project.employee_employee_id) where employee_has_project.project_project_id='"+new_id+"'");
