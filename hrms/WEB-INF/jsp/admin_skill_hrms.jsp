...
<title>HRMS: Skills report</title>
...
<ul id="nav">
<li><a href="http://localhost:8080/admin_skill_hrms.jsp" title="Report" class="on">Report</a></li>
...
rst=stmt.executeQuery("select skill.skill_name, employee_has_skill.experience from skill join employee_has_skill on (skill.skill_id = employee_has_skill.skill_skill_id) where employee_has_skill.employee_username='"+userid+"'");
...
<tbody>
<td bgColor="#006699" width="47" align="center" height="19"><font color="#ffffff"><b>Skill</b></font></td>
<td bgColor="#006699" width="270" height="19"><font color="#ffffff"><b>Experience (years)</b></font></td>
