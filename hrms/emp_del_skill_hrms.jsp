...
<ul id="nav">
<li><a href="admin_skill_hrms.jsp" title="Report">Report</a></li>
<li><a href="admin_skill_srch_hrms.jsp" title="Search">Search</a></li>
<li><a href="emp_add_skill_hrms.jsp" title="Add"  >Add</a></li>
<li><a href="emp_del_skill_hrms.jsp" title="Delete"class="on">Delete</a></li>
</ul>
...
<%
		response.setHeader("Refresh", "2; URL=emp_del_skill_hrms.jsp");
