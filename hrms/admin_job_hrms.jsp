...
<ul id="nav">
<li><a href="admin_job_hrms.jsp" title="Report"class="on">Report</a></li>
...
rst=stmt.executeQuery("select job.job_name, min_salary, max_salary, employee_has_job.start_date, end_date from job join employee_has_job on (job.job_id = employee_has_job.job_job_id) where employee_has_job.employee_username='"+userid+"'");
