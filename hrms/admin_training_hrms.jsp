...
<ul id="nav">
<li><a href="admin_training_hrms.jsp" title="Report" class="on">Report</a></li>
...
rst=stmt.executeQuery("select  training.training_name, start_date, end_date from training join employee_has_training on (training.training_id = employee_has_training.training_training_id) where employee_has_training.employee_username='"+userid+"'");
...
<tbody>
<td bgColor="#006699" width="47" align="center" height="19"><font color="#ffffff"><b>Training</b></font></td>
